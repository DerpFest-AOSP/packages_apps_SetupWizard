...
package org.derpfest.setupwizard.util;
...
import static org.derpfest.setupwizard.SetupWizardApp.ENABLE_RECOVERY_UPDATE;
...
import static org.derpfest.setupwizard.SetupWizardApp.UPDATE_RECOVERY_PROP;
...
public class SetupWizardUtils {
    ...
    private static final String UPDATER_PACKAGE = "org.derpfest.updater";
    ...
    private static void writeDisableNavkeysOption(Context context, boolean enabled) {
        final boolean virtualKeysEnabled = Settings.System.getIntForUser(
                context.getContentResolver(), DerpFestSettings.System.FORCE_SHOW_NAVBAR, 0,
                UserHandle.USER_CURRENT) != 0;
        if (enabled != virtualKeysEnabled) {
            Settings.System.putIntForUser(context.getContentResolver(),
                    DerpFestSettings.System.FORCE_SHOW_NAVBAR, enabled ? 1 : 0,
                    UserHandle.USER_CURRENT);
        }
    }
